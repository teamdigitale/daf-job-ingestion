...
case class TagOntology_old(colName: String, hierarchy: String, vocName: String, ontoTag: Map[String, String]) extends Serializable

// object Standardization_old extends Transformer {
